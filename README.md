...
- **Retail-area export coverage.** Advanced export “Include Retail Area” only finds enclosing `landuse=retail` / `shop=mall` / `landuse=commercial` polygons present in OSM for the search scope; otherwise the place footprint is kept.
